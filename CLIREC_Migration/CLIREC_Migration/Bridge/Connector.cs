...
namespace CLIREC_Migration.Bridge
{
    public static class Connectors
    {
        ...
        {
            /*1!2@3#4$56^7&8*9(10@SQL@DBMS#sa?*/
        ...
        //static string oradb = @"Data Source=(DESCRIPTION =" + "(ADDRESS = (PROTOCOL = TCP)(HOST = 172.17.185.4)(PORT = 1521))" + "(CONNECT_DATA =" + "(SERVER = DEDICATED)" + "(SERVICE_NAME = t24devdb1)));" + "User Id=t24prd;Password=t24prd;";  
        ...
        public static OracleConnection createOracleConnection() {
            var connstring = ConfigurationManager.ConnectionStrings["Ora_conn_Live"].ToString();
